...
export const Route = createFileRoute('/hospitality/hosp2/')({
  component: Hosp2Landing,
})

function Hosp2Landing() {
  const handleLogout = () => {
    ...
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center p-6 relative">
      ...
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl font-bold">Welcome, HOSP 2 Team!</h1>
          <p className="text-muted-foreground text-lg">
            Hostel Check-in Counter
          </p>
        </div>

        {/* Action Button */}
        <div className="pt-8">
          <Link to="/hospitality/hosp2/scanner" className="block">
